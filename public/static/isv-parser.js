! function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).isvParser = e()
}(this, (function() {
    "use strict";
    ...
    var r = function(t) {
        ...
        D = {
            f: i ? N : function(t, e, r) {
                if (R(t), e = g(e, !0), R(r), j) try {
                    return N(t, e, r)
                } catch (t) {}
        ...
        B = function(t, e) {
            var r, o, i, c, u, a, f, l, s = t.target,
                p = t.global,
                y = t.stat,
                d = t.proto,
                ...
                v = p ? M : M[s] || (M[s] = {}),
                g = v.prototype;
            for (i in e) r = !_(p ? i : s + (y ? "." : "#") + i, t.forced) && h && m(h, i), u = v[i], r && (a = t.noTargetGet ? (l = G(h, i)) && l.value : h[i]), c = r && a ? a : e[i], r && typeof u == typeof c || (f = t.bind && r ? I(c, n) : t.wrap && r ? V(c) : d && "function" == typeof c ? I(Function.call, c) : c, (t.sham || c && c.sham || u && u.sham) && F(f, "sham", !0), v[i] = f, d && (m(M, o = s + "Prototype") || F(M, o, {}), M[o][i] = c, t.real && g && !g[i] && F(g, i, c)))
        };
    B({
        target: "Object",
        stat: !0,
    ...
    var W = e((function(t) {
        ...
        ot = i ? Object.defineProperties : function(t, e) {
            R(t);
            for (var r, n = nt(e), o = n.length, i = 0; o > i;) D.f(t, r = n[i++], e[r]);
            return t
        };
    B({
        target: "Object",
    ...
    var it = e((function(t) {
        ...
        ut = function(t, e) {
            return arguments.length < 2 ? ct(M[t]) || ct(n[t]) : M[t] && M[t][e] || n[t] && n[t][e]
        },
        ...
        st = ut("Reflect", "ownKeys") || function(t) {
            var e = ft.f(R(t)),
                r = lt.f;
    ...
    B({
        ...
        getOwnPropertyDescriptors: function(t) {
            for (var e, r, n = h(t), o = P.f, i = st(n), c = {}, u = 0; i.length > u;) void 0 !== (r = o(n, e = i[u++])) && pt(c, e, r);
            return c
        }
    });
    ...
    var vt, gt = e((function(t) {
        ...
        bt = !!Object.getOwnPropertySymbols && !o((function() {
        ...
        jt = n["__core-js_shared__"] || function(t, e) {
            try {
                F(n, t, e)
            } catch (r) {
                n[t] = e
        ...
        At = Math.random(),
        Et = function(t) {
            return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++Pt + At).toString(36)
        },
        xt = Tt("keys"),
        kt = function(t) {
        ...
        Mt = function() {
            ...
            Mt = vt ? function(t) {
                ...
                return t = null, e
            }(vt) : ((e = S("iframe")).style.display = "none", St.appendChild(e), e.src = String("javascript:"), (t = e.contentWindow.document).open(), t.write(_t("document.F=Object")), t.close(), t.F);
            for (var r = rt.length; r--;) delete Mt.prototype[rt[r]];
            return Mt()
        };
    $[Lt] = !0;
    var It = Object.create || function(t, e) {
            var r;
            return null !== t ? (Ct.prototype = R(t), r = new Ct, Ct.prototype = null, r[Lt] = t) : r = Mt(), void 0 === e ? r : ot(r, e)
        },
        Rt = ft.f,
        Nt = {}.toString,
        ...
        Ft = {
            f: function(t) {
                return Dt && "[object Window]" == Nt.call(t) ? function(t) {
                    try {
                        return Rt(t)
                    } catch (t) {
                        return Dt.slice()
        ...
        zt = function(t) {
            return m(Vt, t) || (bt && m(Bt, t) ? Vt[t] = Bt[t] : Vt[t] = Wt("Symbol." + t)), Vt[t]
        },
        Ht = {
            f: zt
        },
    ...
    var Jt = "[object z]" === String(Ut),
        ...
        Qt = Jt ? s : function(t) {
            ...
            }(e = Object(t), qt)) ? r : Yt ? s(e) : "Object" == (n = s(e)) && "function" == typeof e.callee ? "Arguments" : n
        },
        Xt = Jt ? {}.toString : function() {
    ...
    "function" != typeof jt.inspectSource && (jt.inspectSource = function(t) {
        return ee.call(t)
    });
    var re, ne, oe, ie = jt.inspectSource,
        ce = n.WeakMap,
    ...
    var de = {
            ...
            getterFor: function(t) {
                return function(e) {
                    var r;
                    if (!v(e) || (r = ne(e)).type !== t) throw TypeError("Incompatible receiver, " + t + " required");
                    return r
                }
            }
        },
        ...
        ve = function(t, e) {
            var r;
            return Ot(t) && ("function" != typeof(r = t.constructor) || r !== Array && !Ot(r.prototype) ? v(r) && null === (r = r[he]) && (r = void 0) : r = void 0), new(void 0 === r ? Array : r)(0 === e ? 0 : e)
        },
        ge = [].push,
        be = function(t) {
            var e = 1 == t,
            ...
            return function(a, f, l, s) {
                for (var p, d, h = wt(a), v = y(h), g = I(f, l, 3), b = q(v.length), m = 0, O = s || ve, w = e ? O(a, b) : r || c ? O(a, 0) : void 0; b > m; m++)
        ...
        We = function(t, e, r) {
            t === Pe && We(Me, e, r), R(t);
            var n = g(e, !0);
            return R(r), m(_e, n) ? (r.enumerable ? (m(t, we) && t[we][n] && (t[we][n] = !1), r = It(r, {
                enumerable: f(0, !1)
            })) : (m(t, we) || ke(t, we, f(1, {})), t[we][n] = !0), Ge(t, n, r)) : ke(t, n, r)
        },
        ze = function(t, e) {
            R(t);
            var r = h(e),
        ...
        He = function(t) {
            var e = g(t, !0),
                r = Ce.call(this, e);
            return !(this === Pe && m(_e, e) && !m(Me, e)) && (!(r || !m(this, e) || !m(_e, e) || m(this, we) && this[we][e]) || r)
        },
        Ke = function(t, e) {
            var r = h(t),
                n = g(e, !0);
            if (r !== Pe || !m(_e, n) || m(Me, n)) {
                var o = xe(r, n);
                return !o || !m(_e, n) || m(r, we) && r[we][n] || (o.enumerable = !0), o
            }
        },
        Ue = function(t) {
            var e = Le(h(t)),
        ...
        Je = function(t) {
            var e = t === Pe,
                r = Le(e ? Me : h(t)),
                n = [];
            return Oe(r, (function(t) {
                !m(_e, t) || e && !m(Pe, t) || n.push(_e[t])
            })), n
        };
    if (bt || (Gt((Ae = function() {
            if (this instanceof Ae) throw TypeError("Symbol is not a constructor");
            var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
                e = Et(t),
                r = function(t) {
                    this === Pe && r.call(Me, t), m(this, we) && m(this[we], e) && (this[we][e] = !1), Ge(this, e, f(1, t))
                };
            return i && Fe && Ge(Pe, e, {
                configurable: !0,
                set: r
            ...
            return Ve(Et(t), t)
        })), a.f = He, D.f = We, P.f = Ke, ft.f = Ft.f = Ue, lt.f = Je, Ht.f = function(t) {
            return Ve(zt(t), t)
        }, i && ke(Ae.prototype, "description", {
            configurable: !0,
            get: function() {
        ...
        B({
            ...
            stringify: function(t, e, r) {
                ...
                if (n = e, (v(e) || void 0 !== t) && !Be(t)) return Ot(e) || (e = function(t, e) {
                    if ("function" == typeof n && (e = n.call(this, t, e)), !Be(e)) return e
                }), o[1] = e, Ee.apply(null, o)
            }
        })
    }
    Ae.prototype[Se] || F(Ae.prototype, Se, Ae.prototype.valueOf), te(Ae, "Symbol"), $[we] = !0;
    ...
    B({
        ...
        includes: function(t) {
            return !!~String(d(this)).indexOf(ur(t), arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var fr = or("String").includes,
        ...
        pr = function(t) {
            var e = t.includes;
            return t === lr || t instanceof Array && e === lr.includes ? ir : "string" == typeof t || t === sr || t instanceof String && e === sr.includes ? fr : e
        },
        yr = W;
    var dr, hr, vr = function(t, e, r) {
            return e in t ? yr(t, e, {
                value: r,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        mr = br && br.versions,
        Or = mr && mr.v8;
    Or ? hr = (dr = Or.split("."))[0] + dr[1] : gr && (!(dr = gr.match(/Edge\/(\d+)/)) || dr[1] >= 74) && (dr = gr.match(/Chrome\/(\d+)/)) && (hr = dr[1]);
    var wr = hr && +hr,
        Sr = zt("species"),
        jr = function(t) {
            return wr >= 51 || !o((function() {
                var e = [];
    ...
    B({
        ...
        concat: function(t) {
            var e, r, n, o, i, c = wt(this),
                u = ve(c, 0),
                a = 0;
            for (e = -1, n = arguments.length; e < n; e++)
                if (Er(i = -1 === e ? c : arguments[e])) {
                    if (a + (o = q(i.length)) > 9007199254740991) throw TypeError("Maximum allowed index exceeded");
    ...
    var xr, kr, Lr, Cr = or("Array").concat,
        _r = Array.prototype,
        Mr = function(t) {
            var e = t.concat;
        ...
        Rr = kt("IE_PROTO"),
        Nr = Object.prototype,
        Dr = Ir ? Object.getPrototypeOf : function(t) {
            return t = wt(t), m(t, Rr) ? t[Rr] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? Nr : null
        },
        Fr = (zt("iterator"), !1);
    [].keys && ("next" in (Lr = [].keys()) ? (kr = Dr(Dr(Lr))) !== Object.prototype && (xr = kr) : Fr = !0), null == xr && (xr = {});
    var Gr = {
            IteratorPrototype: xr,
            BUGGY_SAFARI_ITERATORS: Fr
        },
        ...
        Ur = (function(t, e, r, n, o, i, c) {
            ...
            if (g && (u = Dr(g.call(new t)), Br !== Object.prototype && u.next && te(u, p, !0, !0)), "values" == o && h && "values" !== h.name && (y = !0, v = function() {
                    return h.call(this)
                }), c && d[zr] !== v && F(d, zr, v), o)
                if (a = {
                        values: s("values"),
    ...
    var Qr, Xr, Zr = me.forEach,
        $r = !!(Xr = []["forEach"]) && o((function() {
            Xr.call(null, Qr || function() {
                throw 1
            }, 1)
        })),
        tn = er("forEach"),
        en = $r && tn ? [].forEach : function(t) {
    ...
    var rn = or("Array").forEach,
        ...
        cn = function(t) {
            var e = t.forEach;
            return t === nn || t instanceof Array && e === nn.forEach || on.hasOwnProperty(Qt(t)) ? rn : e
        },
        un = me.filter,
        an = jr("filter"),
        fn = er("filter");
    ...
    function On(t) {
        for (var e = 1; e < arguments.length; e++) {
            ...
            if (e % 2) cn(r = mn(Object(n), !0)).call(r, (function(e) {
                vr(t, e, n[e])
            }));
    ...
    var wn = function(t) {
        ...
        An = Pn("object" == typeof globalThis && globalThis) || Pn("object" == typeof window && window) || Pn("object" == typeof self && self) || Pn("object" == typeof t && t) || function() {
            return this
        }() || Function("return this")(),
        En = function(t) {
            return "object" == typeof t ? null !== t : "function" == typeof t
        ...
        Ln = !Tn && !jn((function() {
            return 7 != Object.defineProperty((t = "div", kn ? xn.createElement(t) : {}), "a", {
                get: function() {
                    return 7
                }
            }).a;
        ...
        Mn = {
            f: Tn ? _n : function(t, e, r) {
                if (Cn(t), e = function(t, e) {
                        if (!En(t)) return t;
                        var r, n;
                        if (e && "function" == typeof(r = t.toString) && !En(n = r.call(t))) return n;
                        if ("function" == typeof(r = t.valueOf) && !En(n = r.call(t))) return n;
                        if (!e && "function" == typeof(r = t.toString) && !En(n = r.call(t))) return n;
                        throw TypeError("Can't convert object to primitive value")
                    }(e, !0), Cn(r), Ln) try {
                    return _n(t, e, r)
    ...
    function Fn(t) {
        ...
        return "dynamic_shortcuts" === o ? {
            type: "quick-replies",
            content: {
                list: bn(r = e.shortcuts).call(r, Dn)
            },
            context: c
        } : Sn(o, e, {
            context: c
    ...
    function Vn(t) {
        for (var e = 1; e < arguments.length; e++) {
            var r, n = null != arguments[e] ? arguments[e] : {};
            if (e % 2) cn(r = Gn(Object(n), !0)).call(r, (function(e) {
                vr(t, e, n[e])
            }));
            else if (yt) it(t, yt(n));
            else {
            ...
            switch (t.Type.toLowerCase()) {
                case "text":
                    ...
                    switch (t.Text.AnswerSource) {
                        case "BotFramework":
                            p = Mr(p).call(p, function(t, e) {
                                if ("{" !== t[0]) return wn(t);
                                try {
                                    var r, n = JSON.parse(t);
                                    return e && e(n) ? e(n) : n.broadcast ? wn(n.broadcast) : [wn(n.reply), Sn("slot", {
                                        hideShortcuts: !0,
                                        multiLine: !0,
                    ...
                    break;
                case "recommend":
                    p = Mr(p).call(p, (n = t.Recommends, [wn("请问您是否想要咨询以下问题？"), Sn("recommend", {
                    ...
                    break;
                case "knowledge":
                    p = Mr(p).call(p, function(t, e, r) {
                        var n, o = t.RelatedKnowledges ? bn(n = t.RelatedKnowledges).call(n, (function(t) {
                                return {
                                    showTitle: t.Title
                                }
                            })) : [],
